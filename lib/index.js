...
function objToStyles(obj) {
    var styles = '';
    for (var prop in obj) {
        styles += prop + ':' + obj[prop] + '!important;';
    }
    return styles;
}
...
var initSetup = function () {
    ...
    partyTimeContainer.innerHTML = '<button id="party-time-button" class="party-time-controls" style="'+objToStyles({
        "margin-right": "8px",
        color: "white",
        cursor: "pointer",
    ...
    partyTimeContainer.innerHTML += '<input type="file" id="party-upload" class="party-time-controls" style="'+objToStyles({
        width: "150px",
        "margin-right": "8px",
        "font-size": "12px",
    })+'" />';

    partyTimeContainer.innerHTML += '<label for="party-auto-party" class="party-time-controls" style="'+objToStyles({
        "font-weight": "bold",
        color: "white",
        "font-size": "12px"
    })+'">Auto Party</label>';

    partyTimeContainer.innerHTML += '<input type="checkbox" id="party-auto-party" class="party-time-controls" />'

    partyTimeContainer.innerHTML += '<label for="party-debug" class="party-time-controls" style="'+objToStyles({
        "font-weight": "bold",
        color: "white",
        "font-size": "12px"
    })+'">Show Freq</label>';

    partyTimeContainer.innerHTML += '<input type="checkbox" id="party-debug" class="party-time-controls" />'
    ...
    var buttonEle = document.getElementById("party-time-button");
    buttonEle.onclick = startParty;

    var fileUploadEle = document.getElementById("party-upload");
    fileUploadEle.onchange = handleAudioFile;

    var AutoPartyEle = document.getElementById("party-auto-party");
    AutoPartyEle.onchange = handleAutoParty;

    var debugEle = document.getElementById("party-debug");
